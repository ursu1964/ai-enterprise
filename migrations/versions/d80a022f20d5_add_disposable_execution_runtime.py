...
down_revision: str | Sequence[str] | None = "dada975bd485"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "project_id", "idempotency_key", name="uq_execution_run_project_idempotency"
        ),
    )
    op.create_index(
        op.f("ix_execution_runs_project_id"), "execution_runs", ["project_id"], unique=False
    )
    op.create_index(op.f("ix_execution_runs_status"), "execution_runs", ["status"], unique=False)
    op.create_index(
        op.f("ix_execution_runs_work_package_id"),
        "execution_runs",
        ["work_package_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_execution_events_execution_run_id"),
        "execution_events",
        ["execution_run_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "execution_run_id", "sequence", name="uq_execution_test_result_sequence"
        ),
    )
    op.create_index(
        op.f("ix_execution_test_results_execution_run_id"),
        "execution_test_results",
        ["execution_run_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_execution_test_results_execution_run_id"), table_name="execution_test_results"
    )
