...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['source_architecture_artifact_id'], ['artifacts.id'], ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['source_requirements_artifact_id'], ['artifacts.id'], ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('artifact_id'),
    sa.UniqueConstraint('contract_hash')
    )
    op.create_index(op.f('ix_work_packages_planning_run_id'), 'work_packages', ['planning_run_id'], unique=False)
