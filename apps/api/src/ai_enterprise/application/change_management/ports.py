...
class GovernedChangeRepository(Protocol):
    ...
    async def add_transformation_plan(self, plan: TransformationPlan) -> None: ...
    async def get_transformation_plan(
        self, transformation_plan_id: UUID
    ...
    async def add_rollout_plan(self, plan: RolloutPlan) -> None: ...
    async def list_rollout_plans(self, proposal_id: UUID) -> tuple[RolloutPlan, ...]: ...
    async def add_rollback_plan(self, plan: RollbackPlan) -> None: ...
    ...
    async def append_observation(self, observation: ChangeObservation) -> None: ...
    async def get_observation(self, observation_id: UUID) -> ChangeObservation | None: ...
    async def list_observations(self, proposal_id: UUID) -> tuple[ChangeObservation, ...]: ...
    async def append_outcome(self, outcome: ChangeOutcome) -> None: ...
