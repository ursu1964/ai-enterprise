...
| status_documentation | implemented | `docs/bk-r11-evidence-audit-engine-spec.md`<br>`docs/ir/R11-IR-01-evidence-audit-engine.md`<br>`implementation/r11/acceptance-evidence.md`<br>`implementation/r11/api-changes/README.md`<br>`implementation/r11/completion-report.md`<br>`implementation/r11/gap-analysis.md`<br>`implementation/r11/implementation-plan.md`<br>`implementation/r11/migration-plan/README.md`<br>`implementation/r11/repository-baseline.md`<br>`implementation/r11/requirement-matrix.md`<br>`implementation/r11/schema-changes/README.md`<br>`implementation/r11/security-review.md`<br>... 1 more |
